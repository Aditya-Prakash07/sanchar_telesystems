...
// 100% Complete authentic verbatim OEM partners copy from official website: https://www.sanchartelesystems.com/oem-partners
const AUTHENTIC_OEM_DATA = [
    {
        ...
        paragraphs: [
            "Started in 1946 KENWOOD IS WORLD LEADER in mobile radios .It has carved out a worldwide reputation as a leader in its field , based on its advanced technologies, innovative R&D manufacturing quality and superb reliability of its product in mission critical application. Sanchar has been their accredited distributor in India since 1999 to provide best of these sophisticated land mobile radios to its esteemed customer."
        ]
    },
    {
        id: 'diamond',
        ...
        paragraphs: [
            "Established in September 4th 1955 Diamond, Japan are world leader in RF Antennas and accessories. Sanchar has been associated with them to provide excellent antennas to give enhanced permanence to our Radios."
        ]
    },
    {
        id: 'radio-activity',
    ...
    },
    {
        ...
        paragraphs: [
            "Founded in 1923, A JVCKENWOOD company,EF Johnson are committed to providing modern, turnkey solutions for today and the future. They deliver superior products so that customer can focus on their mission - protecting and saving lives. Sanchar are their local representative in India."
        ]
    },
    {
        id: 'yaesu',
    ...
    },
    {
        ...
        paragraphs: [
            "RugGearhas been a global leader in the design and manufacturing of rugged phones and the partner of choice for leading network operators, enterprises and brands around the world.Sanchar has partnered with them for rugged phone suitable for PTT operations."
        ]
    },
    {
...
export default function OemPartners({ partners = [], seo = {} }) {
    ...
    return (
        <MainLayout>
            <Seo
                title={seo?.title || 'Our Preferred Partners — OEM Alliances | Sanchar Telesystems'}
                description={seo?.description || "Sanchar Telesystem has partnered with recognized brand leaders including Kenwood, Diamond, EF Johnson, Yaesu, RugGear, Teltronics, and Nokia to offer best in class communication products."}
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
                        <div>
                            ...
                            <p className="mt-2 text-base text-slate-600 dark:text-steel max-w-3xl leading-relaxed">
                                Sanchar Telesystem has partnered with recognized brand leaders to offer you best in class communication products to meet all your business needs.
                            </p>
                        </div>
                                        ...
                                        <div className="lg:col-span-8 flex flex-col justify-between h-full">
                                            ...
                                            <div className="mt-8 pt-5 border-t border-slate-100 dark:border-white/10 flex flex-wrap items-center justify-between gap-3 text-xs font-mono text-slate-400 dark:text-steel">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span>Direct Technical Support, Warranty &amp; Level-3 Calibration by Sanchar Telesystems</span>
                                                </div>
