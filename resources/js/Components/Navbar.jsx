            ...
            <div className={`transition-all duration-300 ${
                ...
                <nav className="container-content flex items-center justify-between">
                    ...
                    <Link href="/" className="flex items-center gap-3 group shrink-0">
                        ...
                        />
                        <div className="hidden 2xl:block border-l border-slate-300 dark:border-white/15 pl-3">
                            <span className="block text-[11px] font-mono tracking-widest text-slate-900 dark:text-paper/90 uppercase font-semibold whitespace-nowrap">SANCHAR</span>
                            <span className="block text-[9px] font-mono text-slate-500 dark:text-steel tracking-wide whitespace-nowrap">MISSION CRITICAL WIRELESS</span>
                        </div>
                    </Link>
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <svg className={`w-3.5 h-3.5 transition-transform duration-200 shrink-0 ${productsDropdown ? 'rotate-180 text-amber-500 dark:text-beacon' : 'opacity-60'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
